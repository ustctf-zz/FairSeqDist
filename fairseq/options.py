...
def get_parser(desc, default_task='translation'):
    ...
    parser.add_argument('--philly-vc', default=None,
                        help='vc on philly to run the jobs')
...
def add_distributed_training_args(parser):
    ...
    group.add_argument('--master-address-file', default=None, type=str,
                       help='the file storing master node address')
